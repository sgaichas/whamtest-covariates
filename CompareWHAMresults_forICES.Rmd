...
p1 <- plot.NAA.rec.panel(NAAon_ecovoff)
  
p2 <- plot.NAA.rec.panel(NAAon_ecovon)
...
```{r}
p1 <- plot.NAA.rec.panel(NAAoff_ecovoff)
  
p2 <- plot.NAA.rec.panel(NAAoff_ecovon)
...
We dont have a recruitment index in this model
